...
if __name__ == "__main__":
    ...
    pygame.display.init()
    pygame.font.init()
    pygame.display.set_caption("Connect 4 Montecarlo with RAVE")
    ...
    while True:
        ...
        while True:
            ...
            for event in pygame.event.get():
                if event.type == pygame.QUIT:
                    ...
                    if event.key == pygame.K_ESCAPE:
                        ...
                        if gameboard.turn != monte_carlo.symbol: 
            ...
            if gameboard.turn == monte_carlo.symbol: 
                ...
                if mcts_move != (-1, -1):
                    gameboard.apply_move(mcts_move[1] + 1) 
